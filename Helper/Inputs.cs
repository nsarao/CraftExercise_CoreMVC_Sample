...
namespace OAuth2_CoreMVC_Sample.Helper
{
    public class Inputs
    {
        ...
        //NS: Make QBO API call
        internal static Payment CreatePayment(DataService dataService, Customer cust, decimal totalAmount)
        {
            var newPaym = new Payment
            {
            ...
            //var json = JsonConvert.SerializeObject(newPaym);            

            var response = dataService.Add(newPaym);
            return response;           
        }
